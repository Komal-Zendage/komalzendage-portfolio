import { 
  FaLightbulb, FaPaintBrush, FaCode, FaReact, FaServer, FaMobileAlt, 
  FaTools, FaNodeJs, FaStripe, FaVuejs, FaFire, FaDatabase, FaCloud, FaRobot 
} from 'react-icons/fa';

// PROJECT IMAGES - directly from public folder
// Move project1.png and project2.png to public/ folder
// Example: public/project1.png, public/project2.png
...
export const projects = [
  {
    ...
    image: "/project1.png", // <-- public folder
  ...
  },
  {
    ...
    image: "/project2.png", // <-- public folder
